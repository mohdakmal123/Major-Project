    ...
    <div className="flex flex-col md:flex-row bg-gray-900 text-white rounded-lg overflow-hidden max-w-6xl mx-auto shadow-2xl">
      <div className="md:w-1/2 p-8 bg-[url('/placeholder.svg?height=600&width=600')] bg-cover bg-center relative">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-6">
            <p className="mb-2">OUR CONTACTS</p>
            <p>+1 234 567 89 00</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-1 flex items-center">
              ...
              <p className="ml-3 text-sm text-gray-600">{formData.file ? formData.file.name : 'No file chosen'}</p>
            </div>
          </div>
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Send message
            </button>
          </div>
